...
The file-zstr can be used by the execution token file-xt.
...
: (directorieswalker1)  ( c-addr u file-xt file-zstr -- )
   locals| file-zstr file-xt |
   ...
   while  \ Dir dirent
      ...
      if  \ Dir dirent 
         ...
         if  \ Dir dirent
            ...
            .filename dup 
            is-sub-dir if zcount file-xt file-zstr recurse else drop then
         then
      else drop then
   repeat \ Dir x
   \ cr ." Closing: " .s
...
: (directorieswalker2)  ( c-addr u file-xt file-zstr folder-xt -- )
   locals| folder-xt file-zstr file-xt |
      ...
      if  \ Dir dirent 
         ...
         if  \ Dir dirent
            ...
            if  \ Dir dirent
               ...
               .filename dup 
               is-sub-dir if zcount file-xt file-zstr folder-xt recurse else drop then
            then
         else  \ Dir dirent
            drop
         then
...
: (directorieswalker3)  ( c-addr u file-xt file-zstr folder1-xt folder2-xt -- )
   locals| folder2-xt folder1-xt file-zstr file-xt |
   ...
   while   \ Dir dirent
      dup subdir/file
         ...
         if  \ Dir dirent
            ...
            .filename dup 
            is-sub-dir if zcount file-xt file-zstr folder1-xt folder2-xt recurse else drop then
         then
      else drop then
   repeat \ Dir x
   \ cr ." Closing: " .s
