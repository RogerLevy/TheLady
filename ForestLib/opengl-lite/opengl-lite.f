...
: glRotatef ( f: deg x y z -- )  4sfparms glRotatef ;
Function: glTranslatef ( x y z -- )
: glTranslatef ( f: x y z -- ) 3sfparms glTranslatef ;
Function: glScalef ( x y z -- )
: glScalef ( f: x y z -- ) 3sfparms glScalef ;
...
: glMaterialf 1sfparms glMaterialf ;
...
: glPixelStoref 1sfparms glPixelStoref ;
Function: glPixelTransferf ( param Value -- )
: glPixelTransferf   1sfparms glPixelTransferf ;
...
: glTexParameterf 1sfparms glTexParameterf ;
...
: glTexCoord1f  1sfparms glTexCoord1f ;
Function: glTexCoord2f ( n n -- )
: glTexCoord2f  2sfparms glTexCoord2f ;
Function: glTexCoord3f ( n n n -- )
: glTexCoord3f  3sfparms glTexCoord3f ;
Function: glTexCoord3i ( n n n -- )
...
: glAlphaFunc   1sfparms glAlphaFunc ;
...
: glPolygonOffset   2sfparms glPolygonOffset ;
...
: glLineWidth   1sfparms glLineWidth ;
...
: glEvalCoord1f 1sfparms glEvalCoord1f ;
Function: glEvalCoord2f ( gl-float gl-float -- )
: glEvalCoord2f 2sfparms glEvalCoord2f ;
...
: glMap2f  >r >r >r 1sfparms 2>r >r >r 4sfparms r> r> 2r> r> r> r> glMap2f ;
...
: glMap1f   >r >r >r 2sfparms r> r> r> glMap1f ;
...
: glMapGrid1f   2sfparms glMapGrid1f ;
: glMapGrid2d   2df 2>r 2>r >r 2df 2r> 2r> r> glMapGrid2d ;
: glMapGrid2f   2sfparms 2>r >r 2sfparms 2r> r> glMapGrid2f ;
...
: glLightModelf   1sfparms glLightModelf ;
...
: glNormal3f  3sfparms  glNormal3f ;
Function: glFogf ( param Value -- )
: glFogf   1sfparms  glFogf ;
