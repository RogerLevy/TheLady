...
\ Advanced intersections (WIP)
\ ========================= copyright 2014 Roger Levy ==========================


: intersect?  ( line-xyxy line-xyxy -- flag ) \ 8 params
   locals| ry2 rx2 ry1 rx1 ly2 lx2 ly1 lx1 |
   lX1  lX2 -   rY1  rY2 -  *
   rX1  rX2 -   lY1  lY2 -  *  -  0<> ;
\  (X1-X2)*(Y3-Y4) - (Y1-Y2)*(X3-X4)

: intersectbox?   ( line-xyxy rect-xyxy -- flag ) \ 8 params   
   locals| ry2 rx2 ry1 rx1 ly2 lx2 ly1 lx1 |   
...
: pintersect?  ( line-xyxy. line-xyxy. -- flag ) \ 8 params
   locals| ry2 rx2 ry1 rx1 ly2 lx2 ly1 lx1 |
   lX1  lX2 -   rY1  rY2 -  p*
   rX1  rX2 -   lY1  lY2 -  p*  -  0<> ;
\  (X1-X2)*(Y3-Y4) - (Y1-Y2)*(X3-X4)

: pintersectbox?   ( line-xyxy|. rect-xyxy|. -- flag ) \ 8 params   
   locals| ry2 rx2 ry1 rx1 ly2 lx2 ly1 lx1 |   
   \ first check if the line is totally outside the box
   lx1 ly1 lx2 ly2 rx1 ry1 rx2 ry2 overlap? dup -exit drop
   \ then check if either the start or end of the line is in the box
   ...
   lx2 ly2 2dup rx1 ry1 rx2 ry2 overlap? dup ?exit drop
   \ then check if the line intersects with any of the 4 sides
   lx1 ly1 lx2 ly2 rx1 ry1 rx1 ry2 pintersect? dup ?exit drop
   lx1 ly1 lx2 ly2 rx1 ry1 rx2 ry1 pintersect? dup ?exit drop
   lx1 ly1 lx2 ly2 rx2 ry1 rx2 ry2 pintersect? dup ?exit drop
   lx1 ly1 lx2 ly2 rx1 ry2 rx2 ry2 pintersect? ;
   


\ INTERSECT? not the same as this ... this gets the point of intersection too.
char # skip-past
